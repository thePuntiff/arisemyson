...
const index = require('./index-b5c321ae.js');
const deckdeckgoHighlightCodeCarbonTheme = require('./deckdeckgo-highlight-code-carbon-theme-c60f1e7f.js');
...
function loadTheme(theme) {
    ...
    switch (theme) {
        case deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeCarbonTheme['3024-NIGHT']:
            return Promise.resolve().then(function () { return require('./3024-night-3219ec9d.js'); });
        case deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeCarbonTheme['A11Y-DARK']:
            return Promise.resolve().then(function () { return require('./a11y-dark-6758f0dc.js'); });
        case deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeCarbonTheme['BASE16-DARK']:
            return Promise.resolve().then(function () { return require('./base16-dark-91b6c6e2.js'); });
        case deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeCarbonTheme['BASE16-LIGHT']:
            return Promise.resolve().then(function () { return require('./base16-light-acbfdb9c.js'); });
        case deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeCarbonTheme.BLACKBOARD:
            return Promise.resolve().then(function () { return require('./blackboard-54959eb2.js'); });
        case deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeCarbonTheme.COBALT:
            return Promise.resolve().then(function () { return require('./cobalt-9f518b15.js'); });
        case deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeCarbonTheme.DUOTONE:
            return Promise.resolve().then(function () { return require('./duotone-d2ca19eb.js'); });
        case deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeCarbonTheme.HOPSCOTCH:
            return Promise.resolve().then(function () { return require('./hopscotch-66509fe4.js'); });
        case deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeCarbonTheme.LUCARIO:
            return Promise.resolve().then(function () { return require('./lucario-0b4dd1d0.js'); });
        case deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeCarbonTheme.MATERIAL:
            return Promise.resolve().then(function () { return require('./material-d3028c2c.js'); });
        case deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeCarbonTheme.MONOKAI:
            return Promise.resolve().then(function () { return require('./monokai-2acf16b6.js'); });
        case deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeCarbonTheme['NIGHT-OWL']:
            return Promise.resolve().then(function () { return require('./night-owl-4da1885b.js'); });
        case deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeCarbonTheme.NORD:
            return Promise.resolve().then(function () { return require('./nord-90dc427b.js'); });
        case deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeCarbonTheme['OCEANIC-NEXT']:
            return Promise.resolve().then(function () { return require('./oceanic-next-f6fd8a21.js'); });
        case deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeCarbonTheme['ONE-DARK']:
            return Promise.resolve().then(function () { return require('./one-dark-46a78098.js'); });
        case deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeCarbonTheme['ONE-LIGHT']:
            return Promise.resolve().then(function () { return require('./one-light-643ef043.js'); });
        case deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeCarbonTheme.PANDA:
            return Promise.resolve().then(function () { return require('./panda-cf891b63.js'); });
        case deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeCarbonTheme.PARAISO:
            return Promise.resolve().then(function () { return require('./paraiso-e451a2cf.js'); });
        case deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeCarbonTheme.SETI:
            return Promise.resolve().then(function () { return require('./seti-c5032ef4.js'); });
        case deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeCarbonTheme['SHADES-OF-PURPLE']:
            return Promise.resolve().then(function () { return require('./shades-of-purple-520349ee.js'); });
        case deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeCarbonTheme['SOLARIZED-DARK']:
            return Promise.resolve().then(function () { return require('./solarized-dark-74adec4e.js'); });
        case deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeCarbonTheme['SOLARIZED-LIGHT']:
            return Promise.resolve().then(function () { return require('./solarized-light-132b0135.js'); });
        case deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeCarbonTheme.SYNTHWAVE:
            return Promise.resolve().then(function () { return require('./synthwave-743766fe.js'); });
        case deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeCarbonTheme.TWILIGHT:
            return Promise.resolve().then(function () { return require('./twilight-9760bccd.js'); });
        case deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeCarbonTheme.VERMINAL:
            return Promise.resolve().then(function () { return require('./verminal-cc3a858e.js'); });
        case deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeCarbonTheme.VSCODE:
            return Promise.resolve().then(function () { return require('./vscode-8c249e64.js'); });
        case deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeCarbonTheme.YETI:
            return Promise.resolve().then(function () { return require('./yeti-aa37f062.js'); });
        case deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeCarbonTheme.ZENBURN:
            return Promise.resolve().then(function () { return require('./zenburn-3623af88.js'); });
        default:
            return Promise.resolve().then(function () { return require('./dracula-e5b499c2.js'); });
    }
}

const CarbonThemeStyle = ({ style }) => {
    return (index.h("style", null, `
      :host ${style};
    `));
};
...
const DeckdeckgoHighlightCode = class {
    constructor(hostRef) {
        ...
        this.prismLanguageLoaded = index.createEvent(this, "prismLanguageLoaded", 7);
        this.codeDidChange = index.createEvent(this, "codeDidChange", 7);
        this.anchor = '// DeckDeckGo';
        this.anchorZoom = '// DeckDeckGoZoom';
        this.hideAnchor = true;
        this.language = 'javascript';
        this.lineNumbers = false;
        this.terminal = deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeTerminal.CARBON;
        this.editable = false;
        this.theme = deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeCarbonTheme.DRACULA;
        this.editing = false;
    ...
    async loadTheme() {
        if (this.terminal !== deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeTerminal.CARBON || !this.theme) {
    ...
    async loadGoogleFonts() {
        if (this.terminal === deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeTerminal.UBUNTU) {
    ...
    render() {
        const hostClass = {
            ...
            'deckgo-highlight-code-carbon': this.terminal === deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeTerminal.CARBON,
            'deckgo-highlight-code-ubuntu': this.terminal === deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeTerminal.UBUNTU,
        };
        if (this.terminal === deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeTerminal.CARBON) {
            hostClass[`deckgo-highlight-code-theme-${this.theme}`] = true;
        }
        return (index.h(index.Host, { class: hostClass }, this.renderCarbon(), this.renderUbuntu(), index.h("div", { class: "deckgo-highlight-code-container", onMouseDown: () => this.edit(), onTouchStart: () => this.edit() }, index.h("code", null), index.h("slot", { name: "code" }))));
    }
    renderCarbon() {
        if (this.terminal !== deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeTerminal.CARBON) {
            return undefined;
        ...
        return [
            index.h(CarbonThemeStyle, { style: this.themeStyle }),
            index.h("div", { class: "carbon" }, this.renderCarbonCircle('red'), this.renderCarbonCircle('yellow'), this.renderCarbonCircle('green')),
        ];
    }
    renderCarbonCircle(color) {
        return index.h("div", { class: color });
    }
    renderUbuntu() {
        if (this.terminal !== deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeTerminal.UBUNTU) {
            return undefined;
        }
        return (index.h("div", { class: "ubuntu" }, this.renderUbuntuCircle('close'), this.renderUbuntuCircle('minimize'), this.renderUbuntuCircle('maximize'), index.h("p", null, index.h("slot", { name: "user" }))));
    }
    renderUbuntuCircle(mode) {
        const symbol = mode === 'close' ? '&#10005;' : mode === 'minimize' ? '&#9472;' : '&#9723;';
        return index.h("div", { class: mode, innerHTML: symbol });
    }
...
exports.deckgo_highlight_code = DeckdeckgoHighlightCode;
