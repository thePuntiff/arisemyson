...
const DeckdeckgoHighlightCode = class {
    ...
    render() {
        ...
        return (h(Host, { class: hostClass }, this.renderCarbon(), this.renderUbuntu(), h("div", { class: "deckgo-highlight-code-container", onMouseDown: () => this.edit(), onTouchStart: () => this.edit() }, h("code", null), h("slot", { name: "code" }))));
    }
    renderCarbon() {
        if (this.terminal !== DeckdeckgoHighlightCodeTerminal.CARBON) {
            return undefined;
