...
async function generateImageData({
  ...
  if (layout !== `fixed` && !args.maxWidth && !args.maxHeight && metadata.width) {
  ...
  } else if (metadata === null || metadata === void 0 ? void 0 : metadata.dominantColor) {
